namespace OperationLog.Database.Migrations
{
    ...
    public partial class CharToVarchar : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Operations", "StationAddress", c => c.String(maxLength: 6, unicode: false));
            AlterColumn("dbo.Operations", "TableName", c => c.String(maxLength: 21, unicode: false));
            AlterColumn("dbo.Operations", "Program_ProgramId", c => c.String(nullable: false, maxLength: 1, unicode: false));
            AlterColumn("dbo.OperationTypes", "TypeName", c => c.String(maxLength: 30, unicode: false));
            AlterColumn("dbo.Programs", "ProgramId", c => c.String(nullable: false, maxLength: 1, unicode: false));
            ...
            AlterColumn("dbo.Users", "UserType_UserTypeId", c => c.String(nullable: false, maxLength: 1, unicode: false));
            AlterColumn("dbo.UserTypes", "UserTypeId", c => c.String(nullable: false, maxLength: 1, unicode: false));
        ...
        public override void Down()
        {
            ...
            DropPrimaryKey("dbo.UserTypes");
            DropPrimaryKey("dbo.Programs");
            AlterColumn("dbo.UserTypes", "TypeName", c => c.String(maxLength: 30, fixedLength: true, unicode: false));
            ...
            AlterColumn("dbo.Users", "UserName", c => c.String(maxLength: 36, fixedLength: true, unicode: false));
            AlterColumn("dbo.Programs", "ProgramName", c => c.String(maxLength: 30, fixedLength: true, unicode: false));
            AlterColumn("dbo.Programs", "ProgramId", c => c.String(nullable: false, maxLength: 1, fixedLength: true, unicode: false));
            AlterColumn("dbo.OperationTypes", "TypeName", c => c.String(maxLength: 30, fixedLength: true, unicode: false));
            AlterColumn("dbo.Operations", "Program_ProgramId", c => c.String(nullable: false, maxLength: 1, fixedLength: true, unicode: false));
            AlterColumn("dbo.Operations", "TableName", c => c.String(maxLength: 21, fixedLength: true, unicode: false));
            AlterColumn("dbo.Operations", "StationAddress", c => c.String(maxLength: 6, fixedLength: true, unicode: false));
            AlterColumn("dbo.Departments", "DepartmentName", c => c.String(maxLength: 30, fixedLength: true, unicode: false));
            AddPrimaryKey("dbo.UserTypes", "UserTypeId");
            AddPrimaryKey("dbo.Programs", "ProgramId");
            CreateIndex("dbo.Users", "UserType_UserTypeId");
            CreateIndex("dbo.Operations", "Program_ProgramId");
